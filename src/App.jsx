...
import { SessionDetails } from "./routes/SessionDetails/screens/SessionDetails";
import { FeedbackResponse } from "./routes/FeedbackResponse/screens/FeedbackResponse";
import { Messages } from "./routes/Messages/screens/Messages"; // Added import for Messages
...
const router = createBrowserRouter([
  ...
  {
    path: "/my-sessions",
    element: <SessionDetails />, // This would be a separate component in a real app
  },
  {
    path: "/messages",
    element: <Messages />,
